...
<div class="container">
	<ul class="nav nav-pills">
		...
		<li><a href="admin.php?op=adminteamspeakinstanceupload">Teamspeak-Instance Upload</a></li>
    ...
    <table class="table">
		...
		<?php $query = $dbconnect->RunQuery("SELECT * FROM teamspeak_nodes");
			while($row = $dbconnect->FetchAssoc()){ 
				...
				try {
					...
					if($ts3serverinstance["virtualserver_status"] == "online"){
						$teamspeakstatus = "online.png";
					}else{
						$teamspeakstatus = "offline.png";
					}
          ...
          <tr>
			...
			<td><img src="admin/ownmodules/images/<?php echo $dbconnect->HtmlEscape($teamspeakstatus);?>"></td>
