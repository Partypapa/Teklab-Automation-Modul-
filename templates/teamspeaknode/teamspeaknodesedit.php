...
<div class="modal fade" id="ts3serverini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Schliessen</button>
        <input type="submit" name="huso" formaction="admin.php?op=adminteamspeaknodesedit&edit=<?php echo $dbconnect->HtmlEscape($_GET["edit"]);?>&api=createts3serverini" formmethod="post" class="btn btn-primary" value="Speichern">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
	...
	<div class="panel-body">
		...
		<input type="submit" formaction="admin.php?op=adminteamspeaknodesedit&edit=<?php echo $dbconnect->HtmlEscape($_GET["edit"]);?>&api=save" formmethod="post" class="btn btn-default" name="submit" value="Speichern">
	</div></div>
</div>
</form>
	...
	<table class="table">
		...
		<tr>
			<?php foreach($ts3serverinstance->serverGroupList() as $servergrouplist){ ?>
				...
				<td><a href="admin.php?op=adminteamspeaknodesedit&edit=<?php echo $dbconnect->HtmlEscape($_GET["edit"]);?>&servergroupname=<?php echo $dbconnect->HtmlEscape($servergrouplist["name"]);?>&api=tokencreate">Token erstellen</a></td>
			</tr>
			<?php } ?>
	    </tbody>
      </table>
