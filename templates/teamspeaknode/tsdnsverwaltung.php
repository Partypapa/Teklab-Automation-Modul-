	...
	<table class="table">
		...
		<tr>
			...
			while($row = $dbconnect->FetchAssoc()){ ?>
				...
				<td><a href="admin.php?op=adminteamspeaktsdnsverwaltung&edit=<?php echo $dbconnect->HtmlEscape($_GET["edit"]);?>"><img src="admin/ownmodules/images/edit.png"></a> <a href="admin.php?op=adminteamspeaktsdnsverwaltung&nodehost=<?php echo $dbconnect->HtmlEscape($_GET["edit"]);?>&tsdnsid=<?php echo $dbconnect->HtmlEscape($row["id"]);?>"><img src="admin/ownmodules/images/delete.png"></a></td>
			</tr>
			<?php } ?>
	    </tbody>
      </table>
